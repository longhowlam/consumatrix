---
title: 'Scraping Machine learning in R'
author: "Longhow Lam"
...
Neem als voorbeeld de straat van het huis, rechts klik op de straat en klik inspect element, het is een `h2` object met een `class` property. Deze kan je met xpath als volgt opgeven.
...
## gebruiken wat regexpr om prijzen er uit te halen
prijs = str_extract(
  price,
  "[:digit:]+[\\.][:digit:]+[\\.]*[:digit:]*"
) %>%
...
In een for loop kan je deze weer scrapen.
...
Zie ook de Environment browser waar je het object `tmp` kan browsen.

Soms bevat een html pagina een tabel, deze kan je makkelijk vertalen naarr een R data set met `html_table`.
