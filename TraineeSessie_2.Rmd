...
```{r, eval = FALSE}
library(keras)
## dir werkt makkelijk op een linux machine en is noet ondersteunt op een windows machine!
#keras::install_keras()
...
# 60.000 plaatjes die 28 bij 28 zijn
x_train[1,,]
...
We kunnen nu nog een tweede layer toevoegem
...
Nu kan je het model trainen, ik heb alleen 1 epoch gezet, dit model duurt een uur op dit laptopje om te fittenn.
